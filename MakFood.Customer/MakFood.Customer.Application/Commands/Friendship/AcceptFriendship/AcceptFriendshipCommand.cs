...
{
    public class AcceptFriendshipCommand : FriendshipOperationBaseCommand
    {
        
    }

    public class AcceptFriendshipCommandValidatior : FriendshipOperationBaseCommandValidation
    {
        public AcceptFriendshipCommandValidatior()
        {
